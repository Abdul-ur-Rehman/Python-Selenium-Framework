...
for product in products:
    extracted_list.append(product.find_element(By.XPATH,"h4").text)
...
#Validation of discounted price is lesser than total amount

discounted_price = float(driver.find_element(By.CLASS_NAME, "discountAmt").text)
print(f"Discount Price = {discounted_price}")
assert discounted_price < totalAmount
